...
# 에지 검출
edges = cv.Canny(blurred, 150, 300, apertureSize=3)
...
lines = cv.HoughLinesP(roi, 1, np.pi/180, threshold=50, minLineLength=30, maxLineGap=20)
